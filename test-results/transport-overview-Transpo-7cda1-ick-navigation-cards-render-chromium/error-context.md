...
- Name: transport-overview.spec.ts >> Transport Overview >> quick navigation cards render
- Location: e2e\transport-overview.spec.ts:12:7
...
Locator: locator('text=Transport Management')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Transport Management')
