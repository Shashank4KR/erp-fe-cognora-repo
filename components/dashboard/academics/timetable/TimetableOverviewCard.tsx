...
export default function TimetableOverviewCard({
  segments,
}: {
  ...
  return (
    <Card className="flex h-full flex-col p-5 print:hidden">
      <h3 className="text-sm font-semibold text-slate-900">Timetable Overview</h3>
      <p className="mt-0.5 text-[11px] text-slate-400">Periods by school level</p>
      {total === 0 ? (
