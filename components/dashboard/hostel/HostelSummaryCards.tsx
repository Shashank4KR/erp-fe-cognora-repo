...
import { Bed, Users, User, ClipboardList } from "lucide-react";
import Card from "@/components/shared/Card";
import type { SummaryCard } from "@/lib/fixtures/hostel-management-reference-fixture";
...
export default function HostelSummaryCards({ cards }: HostelSummaryCardsProps) {
  return (
