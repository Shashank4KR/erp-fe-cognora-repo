...
export default function EditRoomDialog({ open, onClose, onSave, row }: EditRoomDialogProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Edit Room" maxWidth="max-w-2xl">
