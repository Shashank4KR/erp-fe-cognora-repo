...
interface ExaminationPaginationProps {
  currentPage: number;
  totalPages: number;
...
export default function ExaminationPagination({
  currentPage,
  totalPages,
  onPageChange,
  totalItems,
  itemsPerPage,
}: ExaminationPaginationProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
      <p className="text-xs text-slate-500">
        Showing {start} to {end} of {totalItems} examinations
      </p>
