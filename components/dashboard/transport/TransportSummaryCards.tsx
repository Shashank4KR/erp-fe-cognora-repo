...
import { Bus, Map, Users, User, CalendarDays } from "lucide-react";
import Card from "@/components/shared/Card";
import type { SummaryCard } from "@/lib/fixtures/transport-management-reference-fixture";

const iconMap: Record<string, React.ReactNode> = {
  Bus: <Bus className="h-5 w-5" />,
  Route: <Map className="h-5 w-5" />,
...
export default function TransportSummaryCards({ cards }: TransportSummaryCardsProps) {
  return (
