...
interface ExpenseDateRangePickerProps {
  value: string;
...
export default function ExpenseDateRangePicker({
  value,
  onChange,
  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className={cn(
          "w-full flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-600 border border-slate-200 rounded-lg hover:bg-slate-50 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 text-left"
        )}
      >
