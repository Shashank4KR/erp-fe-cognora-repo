...
import type { SummaryCard } from "@/lib/fixtures/expenses-management-reference-fixture";

const iconMap: Record<string, React.ReactNode> = {
  money: <Receipt className="h-5 w-5" />,
...
export default function ExpenseSummaryCards({ cards }: ExpenseSummaryCardsProps) {
  return (
