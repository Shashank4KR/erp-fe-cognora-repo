...
import { Briefcase, CircleDollarSign, FileClock, TrendingUp, Coins } from "lucide-react";
import Card from "@/components/shared/Card";
import type { SummaryCard } from "@/lib/fixtures/finance-overview-reference-fixture";

const iconMap: Record<string, React.ReactNode> = {
  wallet: <Briefcase className="h-5 w-5" />,
  rupee: <CircleDollarSign className="h-5 w-5" />,
  invoice: <FileClock className="h-5 w-5" />,
