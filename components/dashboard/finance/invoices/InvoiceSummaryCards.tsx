...
import { FileText, IndianRupee, CreditCard, Clock, AlertTriangle, Wallet } from "lucide-react";
import Card from "@/components/shared/Card";
import type { SummaryCard } from "@/lib/fixtures/invoices-reference-fixture";

const iconMap: Record<string, React.ReactNode> = {
  invoice: <FileText className="h-5 w-5" />,
  amount: <IndianRupee className="h-5 w-5" />,
  paid: <CreditCard className="h-5 w-5" />,
  outstanding: <Clock className="h-5 w-5" />,
...
export default function InvoiceSummaryCards({ cards }: InvoiceSummaryCardsProps) {
  return (
