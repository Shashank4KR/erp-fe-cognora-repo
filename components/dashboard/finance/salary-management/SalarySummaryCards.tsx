...
import { Users, Wallet, CreditCard, Clock, Percent, TrendingUp } from "lucide-react";
import Card from "@/components/shared/Card";
import type { SalarySummaryCard } from "@/lib/fixtures/salary-management-reference-fixture";
...
const iconMap: Record<string, React.ReactNode> = {
  ...
  chart: <TrendingUp className="h-5 w-5" />,
};
...
interface SalarySummaryCardsProps {
  cards: SalarySummaryCard[];
}

export default function SalarySummaryCards({ cards }: SalarySummaryCardsProps) {
  return (
